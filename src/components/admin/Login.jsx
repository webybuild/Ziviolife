...
function Login(props) {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-2 justify-center items-center login-bg">
      ...
      <div className="w-11/12 sm:w-1/2 lg:w-1/3 h-1/3 rounded-lg flex items-center justify-center bg-white">
        <div className="flex flex-col gap-6 w-4/5 lg:w-3/5">
          <div className="flex justify-center w-full font-semibold text-base text-[#263D42]">
            <h1>Sign in</h1>
          </div>

          {/* Email */}
          <div className="flex border px-3 items-center">
            <input
          ...
          <button
            className="w-[30%] bg-black navbar text-white py-2 flex justify-center items-center hover:scale-95 text-xs lg:text-sm font-semibold cursor-pointer"
            onClick={login}
          >
            Login
          </button>
      ...
      <div className="text-center">
        <p className="text-white text-sm lg:text-base my-4 font-semibold tracking-wider">
          Ziviolife Pvt. Ltd. | All rights reserved.
        </p>
      </div>
    </div>
  );
